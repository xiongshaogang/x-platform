...
public class ObjectFactory {
	private static final QName _Bounds_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DC", "Bounds");
	private static final QName _Point_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DC", "Point");
	private static final QName _Font_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DC", "Font");
