...
public class ObjectFactory {
	private static final QName _BPMNLabelStyle_QNAME = new QName(
			"http://www.omg.org/spec/BPMN/20100524/DI", "BPMNLabelStyle");
	private static final QName _BPMNLabel_QNAME = new QName(
			"http://www.omg.org/spec/BPMN/20100524/DI", "BPMNLabel");
	private static final QName _BPMNEdge_QNAME = new QName(
			"http://www.omg.org/spec/BPMN/20100524/DI", "BPMNEdge");
	private static final QName _BPMNDiagram_QNAME = new QName(
			"http://www.omg.org/spec/BPMN/20100524/DI", "BPMNDiagram");
	private static final QName _BPMNShape_QNAME = new QName(
			"http://www.omg.org/spec/BPMN/20100524/DI", "BPMNShape");
	private static final QName _BPMNPlane_QNAME = new QName(
	...
	public JAXBElement<BPMNLabelStyle> createBPMNLabelStyle(BPMNLabelStyle value) {
		return new JAXBElement(_BPMNLabelStyle_QNAME, BPMNLabelStyle.class,
				null, value);
	}
	...
	public JAXBElement<BPMNDiagram> createBPMNDiagram(BPMNDiagram value) {
		return new JAXBElement(_BPMNDiagram_QNAME, BPMNDiagram.class, null,
				value);
	}
