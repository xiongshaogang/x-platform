package com.xplatform.base.workflow.core.facade.dao.impl;
...
public class FlowDaoImpl implements FlowDao {
	private Logger logger = LoggerFactory.getLogger(FlowDaoImpl.class);
	...
	public String getDefXmlByDeployId(String deployId) {
		...
		String defXml = null;
		try {
			this.jdbcTemplate.query(sql, new Object[] { deployId },
					new AbstractLobStreamingResultSetExtractor() {
						public void streamData(ResultSet rs)
								throws SQLException, IOException {
							FileCopyUtils.copy(lobHandler
									.getBlobAsBinaryStream(rs, "BYTES_"),
									contentOs);
						}
					});
