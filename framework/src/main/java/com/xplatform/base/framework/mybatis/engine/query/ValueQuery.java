 ...
 * 
 * <STRONG>创建时间</STRONG> : Sep 13, 2012 4:36:19 PM<p>
 * <STRONG>修改历史</STRONG> :<p>
 *<pre>
 * 修改人                        修改时间                        修改内容
 * ---------------         -------------------         -----------------------------------
 * mengfx@huilan.com        Sep 13, 2012 4:36:19 PM
 *</pre>  
 */
public interface ValueQuery <T extends Query<T, U> , U> extends RelationQuery<T,U>{
	
	ValueQuery<T,U> values(Map<String,String> map);
}
