 ...
 */
public class LikeLExpression implements Criterion {
	private final String propertyName;
	private final boolean ignoreCase;//true 区分大小写 false不区分大小写
	private final String value;

	public LikeLExpression(String propertyName, boolean ignoreCase,String value) {
		this.propertyName = propertyName;
		this.ignoreCase = ignoreCase;
		this.value = value;
	}

	public LikeLExpression(String propertyName,String value){
