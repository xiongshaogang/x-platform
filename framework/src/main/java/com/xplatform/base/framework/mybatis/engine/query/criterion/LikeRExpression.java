 ...
 */
public class LikeRExpression implements Criterion {
	private final String propertyName;
	private final boolean ignoreCase;//true 区分大小写 false不区分大小写
	private final String value;

	public LikeRExpression(String propertyName, boolean ignoreCase,String value) {
		this.propertyName = propertyName;
		this.ignoreCase = ignoreCase;
		this.value = value;
	}

	public LikeRExpression(String propertyName,String value){
...
//			
//		}else{
//			return "UPPER("+ propertyName +") LIKE UPPER('%${"+Strings.replace(this.propertyName, AppConstant.DOT, AppConstant.UNDERLINE)+"}%')";
//		}
