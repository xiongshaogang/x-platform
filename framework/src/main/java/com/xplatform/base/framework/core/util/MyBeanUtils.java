...
//              String type = origDescriptors[i].getPropertyType().toString();
  ...
  /**
	 ...
	 * copy
	 */
  public static void copyBeanNotNull2Bean(Object databean,Object tobean)throws BusinessException
  {
	  PropertyDescriptor origDescriptors[] =
...
//          String type = origDescriptors[i].getPropertyType().toString();
  ...
  /**
 	 ...
 	 * copy
 	 */
   public static void copyBeanUpdateBean(Object databean,Object tobean)throws Exception
   {
 	  PropertyDescriptor origDescriptors[] =
           PropertyUtils.getPropertyDescriptors(databean);
       for (int i = 0; i < origDescriptors.length; i++) {
