...
public class PinyinUtil {
	...
	public static String getPinYin(String src) {
		char[] t1 = null;
		t1 = src.toCharArray();
		// com.xplatform.base.framework.core.util.LogUtil.info(t1.length);
		String[] t2 = new String[t1.length];
		// com.xplatform.base.framework.core.util.LogUtil.info(t2.length);
		// 设置汉字拼音输出的格式
		...
		try {
			for (int i = 0; i < t0; i++) {
				// 判断能否为汉字字符
				// com.xplatform.base.framework.core.util.LogUtil.info(t1[i]);
