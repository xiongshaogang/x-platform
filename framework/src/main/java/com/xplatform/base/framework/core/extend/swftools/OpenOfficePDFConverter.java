package com.xplatform.base.framework.core.extend.swftools;
...
public class OpenOfficePDFConverter implements PDFConverter {
	...
	public void convert2PDF(String inputFile, String pdfFile, String extend) {
		...
		if (extend.equals("txt")) {
			...
			if (new File(odtFile).exists()) {
				com.xplatform.base.framework.core.util.LogUtil.info("odt文件已存在！");
				inputFile = odtFile;
			} else {
		...
		//pdfFile = pdfFile.replaceAll(" ", "").replaceAll("　", "");
		 com.xplatform.base.framework.core.util.LogUtil.info("进行文档转换转换:" + inputFile + " --> " + pdfFile);
		...
		try {
			...
			com.xplatform.base.framework.core.util.LogUtil.info(e.getMessage());
		}
		
		stopService();
	    com.xplatform.base.framework.core.util.LogUtil.info("进行文档转换转换---- 结束----");
	}
	...
	public static void startService() {
		...
		try {
			...
			com.xplatform.base.framework.core.util.LogUtil.info("office转换服务启动成功!");
		} catch (Exception ce) {
			com.xplatform.base.framework.core.util.LogUtil.info("office转换服务启动失败!详细信息:" + ce);
		}
	}

	public static void stopService() {
		com.xplatform.base.framework.core.util.LogUtil.info("关闭office转换服务....");
		if (officeManager != null) {
			officeManager.stop();
		}
		com.xplatform.base.framework.core.util.LogUtil.info("关闭office转换成功!");
	}
}
