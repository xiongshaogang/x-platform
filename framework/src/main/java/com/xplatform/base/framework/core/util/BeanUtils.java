...
import com.xplatform.base.framework.core.converter.BeanDateConverter;

/**
 * 
 * description :bean的常规操作
 *
 * @version 1.0
 * @author xiehs
 * @createtime : 2014年6月17日 下午5:10:23
 * 
 * 修改历史:
 * 修改人                                          修改时间                                                  修改内容
 * --------------- ------------------- -----------------------------------
 * xiehs        2014年6月17日 下午5:10:23
 *
 */
public class BeanUtils {
	 ...
	 * @return
	 */
	public static Object isEmpty(Object o, Object replace) {
		boolean flag = false;
		if (o == null){
			flag = true;
