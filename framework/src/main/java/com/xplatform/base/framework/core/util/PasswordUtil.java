...
public class PasswordUtil {
	...
	public static void main(String[] args) {
		...
		com.xplatform.base.framework.core.util.LogUtil.info("明文:" + str);
		com.xplatform.base.framework.core.util.LogUtil.info("密码:" + password);
		...
		try {
			...
			com.xplatform.base.framework.core.util.LogUtil.info("密文:" + ciphertext);
			String plaintext = PasswordUtil.decrypt(ciphertext, password, salt);
			com.xplatform.base.framework.core.util.LogUtil.info("明文:" + plaintext);
