package com.xplatform.base.poi.excel.export.base;
...
import com.xplatform.base.poi.excel.entity.params.ComparatorExcelField;
...
public class ExportBase {
	...
	public void getAllExcelField(String[] exclusions, String targetId, Field[] fields,
		...
		for (int i = 0; i < fields.length; i++) {
			...
			if (POIPublicUtil.isCollection(field.getType())) {
				...
				excelEntity.setField(field.getName());
	...
	public Object getCellValue(ExcelExportEntity entity, Object obj) throws Exception {
		//obj就是Iterator中的1个next() (比如List<TeacherEntity>中的一个TeacherEntity)
		...
		if (needHanlderList != null) {
			if (needHanlderList.contains(entity.getName())) {
				value = dataHanlder.exportHandler(obj, entity.getName(), value);
			} else if (needHanlderList.contains((entity.getField()))) {
				value = dataHanlder.exportHandler(obj, entity.getField(), value);
			}
		}  
