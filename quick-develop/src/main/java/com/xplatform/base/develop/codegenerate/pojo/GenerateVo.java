 ...
 * @version V1.0
 */
public class GenerateVo implements java.io.Serializable{
	/**
	 * 
	 */
	...
	private String cEntityName;//关联表实体名
	private String cField;//关联字段名
	 ...
	 * 表单配置抬头
	 */
	private MetaDataEntity cgFormHead;
	
	/**
	 * 表单配置抬头
	 */
	private GenerateConfigEntity baseFormEntity;

	/**
	 * 表单属性配置
	 */
	private List<GenerateFieldEntity> columns ;
	...
	public MetaDataEntity getCgFormHead() {
		return cgFormHead;
	}

	public void setCgFormHead(MetaDataEntity cgFormHead) {
		this.cgFormHead = cgFormHead;
	}
	
	public GenerateConfigEntity getBaseFormEntity() {
		return baseFormEntity;
	}

	public void setBaseFormEntity(GenerateConfigEntity baseFormEntity) {
		this.baseFormEntity = baseFormEntity;
	}
	
	public List<GenerateFieldEntity> getColumns() {
		return columns;
	}

	public void setColumns(List<GenerateFieldEntity> columns) {
	 ...
	 * @throws Exception
	 */
	public GenerateVo deepCopy() throws Exception{  
        ...
        return (GenerateVo) ois.readObject();  
    } 
}
