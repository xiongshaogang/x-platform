...
public class JeecgCodeDeleteUtil {
	...
	public static void init(String gn_package, String name) {
		action_url = src_url + "/" + "action" + "/" + gn_package + "/" + name
				+ "Action.java";
		entity_url = src_url + "/" + "entity" + "/" + gn_package + "/" + name
				+ "Entity.java";
		page_url = src_url + "/" + "page" + "/" + gn_package + "/" + name
				+ "Page.java";
		service_url = src_url + "/" + "service" + "/" + gn_package + "/" + name
				+ "ServiceI.java";
		service_impl_url = src_url + "/" + "service" + "/" + "impl" + "/"
				+ gn_package + "/" + name + "ServiceImpl.java";
		jsp_url = web_url + "/" + gn_package + "/" + name + ".jsp";
		jsp_add_url = web_url + "/" + gn_package + "/" + name + "-main-add.jsp";
		jsp_edit_url = web_url + "/" + gn_package + "/" + name
				+ "-main-edit.jsp";
