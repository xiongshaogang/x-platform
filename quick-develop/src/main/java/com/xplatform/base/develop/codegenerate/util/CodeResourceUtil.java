package com.xplatform.base.develop.codegenerate.util;
...
public class CodeResourceUtil {
	...
	private static final ResourceBundle bundlePath = ResourceBundle
			.getBundle("ucg/ucg_config");

	public static String DIVER_NAME = "com.mysql.jdbc.Driver";

	public static String URL = "jdbc:mysql://localhost:3306/jeecg?useUnicode=true&characterEncoding=UTF-8";

	public static String USERNAME = "root";

	public static String PASSWORD = "admin";

	public static String DATABASE_NAME = "jeecg";
	...
	public static String java_path = "webapp";
	
	public static String web_project_name = "webapp";
	...
	static {
		...
		JSPPATH = web_root_package + "/" + "webpage" + "/" + getJspPath()
				+ "/";
	}
	...
	public static String getWeb_project_name() {
		return bundlePath.getString("web_project_name");
	}
	...
	public static final String getJava_path() {
		return bundlePath.getString("java_path");
	}
	...
	public  static String getJspPath(){
		String prj_path = CodeResourceUtil.getProject_path();
		String str = prj_path.split("/")[prj_path.split("/").length-1].toLowerCase();
		String jsp_path="";
		if(StringUtil.equals(str, "webapp")){
			jsp_path = "web";
		}else if(StringUtil.equals(str, "quick-develop")){
			jsp_path = "develop";
		}else if(StringUtil.equals(str, "platform")){
			jsp_path = "platform";
		}else if(StringUtil.equals(str, "framework")){
			jsp_path = "framework";
		}else{
			jsp_path = "web";
		}
