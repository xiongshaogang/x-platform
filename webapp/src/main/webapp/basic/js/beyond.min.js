...
function InitiateSideMenu() {
    ...
    function() {
        ...
        //隐藏sidebar时，处理slimscroll的overflow，以显示hover元素
        if($("#sidebar").hasClass("menu-compact")){
        	$("#sidebar .slimScrollDiv, #sidebar .slimScrollDiv > div").css("overflow", "visible");
        }else{
        	$("#sidebar .slimScrollDiv, #sidebar .slimScrollDiv > div").css("overflow", "hidden");
        }
    });
