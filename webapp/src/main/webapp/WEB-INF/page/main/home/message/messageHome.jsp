...
<div id="im-recent-div" class="sub-menu-pannel">
	<div class="text-center list-title">项目</div>
	<div class="sys-list">
	...
	<div class="chat-box-container">
		<div id="chat-content" class="chat-box">
			<div class="chat-main" id="chatMain">
				<div class="hidden" id="sys-messageList--">
				
				</div>
				
				<div class="sys-list">
					<ul id="sys-messageList" class="list-style-none sys-list-container">
<!-- 						<li class="list-item">
							<div class="item-top">
...
<script>
	Easemob.im.config = {
		...
		/*
		    连接时提供appkey
		 */
		appkey : "summer99891112#summertest",
		https : true
	};
	...
	var createContactLi = function(to, message, chattype) {
		...
		if (chattype && chattype == 'groupchat') {
			...
			//创建群聊联系人项
			var lielem = $('<li><div class="avatar without-bubble" ></div>' + '<div class="info"><span class="text-overflow username">' + roomsName
	...
	var appendMsg = function(from, contact, message, chattype) {
		...
		var name = contactCache.get(from).name;
		var portrait = contactCache.get(from).portrait ? '${attachForeRequest}' + contactCache.get(from).portrait : 'basic/img/avatars/avatar_80.png';
			...
			var opt = {
				...
				onFileUploadComplete : function(data) {
					...
					if (file && file.files) {
						...
						//若因为某些原因 ,没有上传的要素了(type="file"),那么就取上传成功返回的数据来追加页面
	...
	$(document).ready(function() {
		...
		$("#group-settings").on("click", function(e) {
			...
			if ($(".menu-pannel-pop").hasClass("active")) {
				$(".menu-pannel-pop .pop-title").text("群设置");
				$(".menu-pannel-pop .body-content").empty().load("orgGroupController.do?groupSettingsEdit&groupId=" + curRoomId);
			}
		});
