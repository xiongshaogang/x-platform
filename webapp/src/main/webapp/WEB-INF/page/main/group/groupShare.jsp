...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<div class="body-container">
			...
			<div class="body-content">
				...
				<div class="top-inner text-center">
					<div class="avatar">
						<img src="basic/img/avatars/avatar_80.png" alt="头像">
					</div>
				...
				<div class="bottom-inner">
					<div class="form-box">
						...
						<div class="form-btn">
							<button class="btn btn-orange" onclick="groupShare.joinTeam()">加入团队</button>
						</div>
					</div>
				</div>
			</div>
	...
	var groupShare = {
			loadPortrait : function(){
				...
				var myportrait = portrait ? 'basic/img/avatars/avatar_80.png' : '${attachForeRequest}' + portrait;
			...
			joinTeam : function(){
				...
				var data = {"groupId" : groupId,"phone" : phone,"userName" : phone,"password" : password};
				
				var myurl = "orgGroupController.do?addUserFromWeb";
				$.ajax({
					async : true,
					type : "get",
					url : myurl,
