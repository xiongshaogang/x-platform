...
<t:datagrid name="myTaskList" checkbox="true" fitColumns="true" title="任务列表" actionUrl="taskController.do?myTaskDatagrid" idField="id" fit="true" queryMode="separate">
  ...
  <t:dgOpenOpt title="任务处理" icon="glyphicon glyphicon-pencil icon-color" exParams="{noheader:true,optFlag:'close'}"  url="taskController.do?toStart&taskId={id}" width="1000" height="500" ></t:dgOpenOpt>

  <t:dgToolBar title="批量处理" preinstallWidth="1"  height="300" icon="glyphicon glyphicon-pencil icon-color" url="taskController.do?bacthCompleteEdit" funname="bacthComplete"></t:dgToolBar>
</t:datagrid>
<script>
