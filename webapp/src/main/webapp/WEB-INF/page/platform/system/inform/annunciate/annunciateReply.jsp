...
$(function(){
	//removeButton(getD($("#annunciateFormobj")),1);
	var needReply = "${me.needReply}";
	...
	if(needReply == '1' && replyContent == ''){
		var myButton = [{
				...
				handler : function() {
					...
					$("#btn_type").val("reply");
					saveObj("btn_sub","annunciateFormobj");
				}
	    },{
		id : 'transpond',
		text : '转发',
		...
		addButton(getD($("#annunciateFormobj")),myButton,1);
	}else{
		var myButton = [{
		id : 'transpond',
		text : '转发',
...
function showOffice(){
  ...
  <t:formvalid formid="annunciateFormobj" gridId="annunciateInformList" action="annunciateController.do?saveReply" refresh="true">
		...
		<table cellpadding="0" cellspacing="1" class="formtable" style="margin-right: 100px;">
		   <tr >
			...
			<iframe src="messageController.do?printFile&id=${me.id }&name=annunciateTemplate.doc"  style="width: 0;height: 0;padding:0px;border:0px;" id="office_iframe" name="office_iframe"></iframe>
			</td>
			</tr>
		   <tr>
