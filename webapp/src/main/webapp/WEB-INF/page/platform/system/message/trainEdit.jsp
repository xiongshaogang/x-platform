...
$(function(){
  ...
  <t:formvalid formid="formobj" gridId="trainList" action="messageController.do?sendMsg" >
		...
		<table cellpadding="0" cellspacing="1" class="formtable" >
			<tr>
				<td class="td_title">
					<label class="Validform_label">
						<span style="color:red">*</span>通知发自:
					</label>
				</td>
				<td class="value">
			...
			<tr>
				...
				<td class="value">
				    <input id="businessObj" width="100%" name="businessObj" datatype="*1-50" type="text" class="inputxt" value='${business.businessObj}'>
				</td>
			</tr>
			<tr>
			    <td class="td_title">
				...
				<td class="value">
				    ...
				    <c:otherwise>
				    <t:comboBox name="company"  id="company"  dictCode="companyType" value="${business.companyId }" ></t:comboBox></c:otherwise>
				    </c:choose> --%>
			...
			<%-- <tr>
				...
				<td class="value" colspan="5">
				   ...
				   </div><c:if test="${optFlag !='detail'}"><a href="#" onclick="uploadTrain()" class="awsm-icon-cloud-upload" style="color:blue;">添加附件</a></c:if>
 				</td>
			</tr> --%>
			<%-- <tr>
				<td class="td_title">
...
<script type="text/javascript">
	...
	function uploadTrain() {
		commonPageUpload({
			...
			isNeedToType : false, 
			finishUploadCallback:"trainUpload(allFiles)"
		});
	}
	function trainUpload(result){
