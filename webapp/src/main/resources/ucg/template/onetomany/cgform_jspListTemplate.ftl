...
<div class="easyui-layout" fit="true">
  ...
  <#list columns as po>
   ...
   <t:dgToolBar title="查看" icon="awsm-icon-search" url="${entityName?uncap_first}Controller.do?${entityName?uncap_first}Edit" funname="detail" buttonType="GridDetail" width="1024" height="620" exParams="{formId:'${entityName?uncap_first}Formobj'}"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
