...
<%@include file="/context/mytags.jsp"%>
  <t:formvalid callback="reflashTree" formid="${entityName?uncap_first}Formobj" layout="table" action="${entityName?uncap_first}Controller.do?save${entityName}" refresh="true" gridId="${entityName?uncap_first}List">
	    <input id="parentId" name="parentId" type="hidden" value="${'$'}{${entityName?uncap_first}.parent.id }">
	<#list columns as po>
		<#if po.editShow == 'N' && po.fieldName != 'parentId'>
