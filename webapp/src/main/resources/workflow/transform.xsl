...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	xmlns:ht="http://www.ucg.cn/BPMN20EXT"
	...
	<xsl:template match="/">
		...
		xmlns:omgdi="http://www.omg.org/spec/DD/20100524/DI" 
		xmlns:ht="http://www.ucg.cn/BPMN20EXT"
		xsi:schemaLocation="http://www.ucg.cn/BPMN20EXT BPMN20EXT.xsd"
	...
	<xsl:template match="/diagram">
		...
		<xsl:if test="contains($comp,'Event') or contains($comp,'Task') or contains($comp,'SequenceFlow') or contains($comp,'SubProcess') or contains($comp,'Gateway')">
			<process>
				...
				<extensionElements>
					<!-- 流程开始事件监听器 -->
					<activiti:executionListener class="com.xplatform.base.workflow.core.facade.listener.StartEventListener" event="start" />
					<!-- 流程结束事件监听器 -->
					<activiti:executionListener class="com.xplatform.base.workflow.core.facade.listener.EndEventListener" event="end" />
				</extensionElements>
	...
	<xsl:template match="bg:SubProcess">
		<xsl:for-each select=".">
			<subProcess>
				...
				<extensionElements>
					<!-- 流程开始事件监听器 -->
					<activiti:executionListener class="com.xplatform.base.workflow.core.facade.listener.SubProcessStartListener" event="start" />
					<!-- 流程结束事件监听器 -->
					<activiti:executionListener class="com.xplatform.base.workflow.core.facade.listener.SubProcessEndListener" event="end" />
				</extensionElements>
			...
			<xsl:choose>
				<xsl:when test="@user='true'">
					<userTask>
						...
						<extensionElements>
							<activiti:taskListener event="create" class="com.xplatform.base.workflow.core.facade.listener.TaskCreateListener" />
							<activiti:taskListener event="assignment" class="com.xplatform.base.workflow.core.facade.listener.TaskAssignListener" />
							<activiti:taskListener event="complete" class="com.xplatform.base.workflow.core.facade.listener.TaskCompleteListener" />
				...
				<xsl:when test="@script='true'">
					<serviceTask activiti:class="com.ucg.platform.service.bpm.ScriptTask">
						...
						<extensionElements>
							<activiti:executionListener class="com.xplatform.base.workflow.core.facade.listener.AutoTaskListener" event="start" />
							<xsl:call-template name="setTaskExtProperties">
								<xsl:with-param name="obj" select="."></xsl:with-param>
							</xsl:call-template>
						</extensionElements>
				...
				<xsl:when test="@multiInstance='true'">
					<userTask>
						...
						<extensionElements>
							<activiti:taskListener event="create" class="com.xplatform.base.workflow.core.facade.listener.TaskSignCreateListener" />
							<activiti:taskListener event="assignment" class="com.xplatform.base.workflow.core.facade.listener.TaskAssignListener" />
							<activiti:taskListener event="complete" class="com.xplatform.base.workflow.core.facade.listener.TaskCompleteListener" />
							<xsl:call-template name="setTaskExtProperties">
								<xsl:with-param name="obj" select="."></xsl:with-param>
				...
				<xsl:when test="@startSubFlow='true'">
					<callActivity>
						...
						<extensionElements>
							<activiti:executionListener event="start" class="com.xplatform.base.workflow.core.facade.listener.CallSubProcessStartListener"></activiti:executionListener>
							<activiti:executionListener event="end" class="com.xplatform.base.workflow.core.facade.listener.CallSubProcessEndListener"></activiti:executionListener>
