...
<div class="easyui-layout" style="width:100%;height:100%;border:0px">  
    ...
    <t:tree id="${entityName?uncap_first}_tree"   gridTreeFilter="${cField}"
  ...
  <#list columns as po>
  <#if fieldMeta[po.fieldName] != cField?upper_case>
   ...
   <t:dgToolBar title="批量删除" callback="refreshTable" icon="awsm-icon-remove" url="${entityName?uncap_first}Controller.do?batchDelete" funname="deleteALLSelect" buttonType="GridDelMul"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
