 ...
 *
 */
public interface ProcessInstCptoService {
	...
	public void handlerCopyTask(ProcessInstanceEntity processRun,Map<String, Object> vars, String preTaskUserId,DefinitionEntity bpmDefinition,String funcType) throws BusinessException ;
	
	/**
	 * @author xiaqiang
	 * @createtime 2014年12月20日 下午5:46:52
	 * @Decription 通过任务ID或实例ID查询抄送人
	 *
	 * @param id
	 * @param type
	 * @return
