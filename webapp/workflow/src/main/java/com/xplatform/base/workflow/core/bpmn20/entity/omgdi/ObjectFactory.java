...
public class ObjectFactory {
	private static final QName _Style_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DI", "Style");
	private static final QName _LabeledEdge_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DI", "LabeledEdge");
	private static final QName _Plane_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DI", "Plane");
	private static final QName _LabeledShape_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DI", "LabeledShape");
	private static final QName _Shape_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DI", "Shape");
	private static final QName _Edge_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DI", "Edge");
	private static final QName _Node_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DI", "Node");
	private static final QName _Diagram_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DI", "Diagram");
	private static final QName _Label_QNAME = new QName(
			"http://www.omg.org/spec/DD/20100524/DI", "Label");
	private static final QName _DiagramElement_QNAME = new QName(
	...
	public JAXBElement<LabeledEdge> createLabeledEdge(LabeledEdge value) {
		return new JAXBElement(_LabeledEdge_QNAME, LabeledEdge.class, null,
				value);
	}
	...
	public JAXBElement<LabeledShape> createLabeledShape(LabeledShape value) {
		return new JAXBElement(_LabeledShape_QNAME, LabeledShape.class, null,
				value);
	}
	...
	public JAXBElement<DiagramElement> createDiagramElement(DiagramElement value) {
		return new JAXBElement(_DiagramElement_QNAME, DiagramElement.class,
				null, value);
	}
}