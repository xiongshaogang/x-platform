...
public class NodeUserCalculateTaskExecutorBranchLeader implements NodeUserCalculate {
	...
	public List<UserEntity> getExecutor(NodeUserEntity nodeUser,
		...
		//通过员工获取
		return userService.getBranchLeadersByUserId(taskOpinion.getExeUserId());
