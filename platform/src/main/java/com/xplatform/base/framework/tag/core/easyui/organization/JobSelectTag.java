...
public class JobSelectTag extends TagSupport {
	...
	private String icon = "awsm-icon-indent-right";//选择按钮图标
	...
	public int doEndTag() throws JspTagException {
		...
		String html = viewEngine.parseTemplate("/com/xplatform/base/framework/tag/core/ftl/jobSelect.ftl", root);
		try {
			out.print(html);
			out.flush();
		} catch (IOException e) {
