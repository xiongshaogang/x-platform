...
public class DataGridDelOptTag extends TagSupport {
	...
	private String icon = "glyphicon glyphicon-remove icon-color";//按钮图标
	...
	public int doEndTag() throws JspTagException {
		...
		parent.setDelUrl(url, title, message, exp, funname, operationCode, callback, icon, exParams,isShowInViewPage);
		return EVAL_PAGE;
	}
