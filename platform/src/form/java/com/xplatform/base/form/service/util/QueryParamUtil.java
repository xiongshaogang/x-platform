...
//	public static void loadQueryParams(HttpServletRequest request, AppFormField b, Map params) {
...
//					params.put(b.getFieldName(), BusinessConst.OP_LIKE + value);
//				} else {
//					params.put(b.getFieldName(), BusinessConst.OP_EQ + value);
//				}
//			}
...
//				String re = BusinessConst.OP_RQ + begin;
//				if (!StringUtil.isEmpty(end)) {
//					re += " AND " + b.getFieldName() + BusinessConst.OP_LQ + end;
//				}
//				params.put(b.getFieldName(), re);
//			} else if (!StringUtil.isEmpty(end)) {
//				String re = BusinessConst.OP_LQ + end;
//				params.put(b.getFieldName(), re);
//			}
//		}
//	}
	...
	public static String applyType(String fieldType, String value) {
		if (!StringUtil.isEmpty(value)) {
			String result = "";
			if (BusinessConst.TYPE_STRING.equalsIgnoreCase(fieldType)) {
				result = "'" + value + "'";
			} else if (BusinessConst.TYPE_DATE.equalsIgnoreCase(fieldType)) {
				result = getDateFunction(value, "yyyy-MM-dd");
			} else if (BusinessConst.TYPE_DOUBLE.equalsIgnoreCase(fieldType)) {
				result = value;
			} else if (BusinessConst.TYPE_INTEGER.equalsIgnoreCase(fieldType)) {
				result = value;
			} else {
				result = value;
			}
