...
@Entity
@Table(name="t_sys_message_train",schema="")
public class TrainEntity extends AssignedOperationEntity {
	...
	@Column(name ="train_time",nullable=true)
	...
	@Column(name ="train_person",nullable=true,length=50)
	...
	@Column(name ="train_place",nullable=true,length=50)
	...
	@Column(name ="train_obj",nullable=true,length=50)
