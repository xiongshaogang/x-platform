...
@Entity
@Table(name="t_sys_message_meeting",schema="")
public class MeetingEntity extends AssignedOperationEntity {
	...
	private String meetingPerson;//与会人员
	...
	@Column(name ="meeting_person",nullable=true,length=50)
	...
	@Column(name ="meeting_place",nullable=true,length=50)
